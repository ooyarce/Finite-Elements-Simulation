...
fid = open("malla_con_elipse_5_OFICIAL.msh","r")
...
for e in Quadrangles:
    ...
    print (f"elemento : {e} espesor original : {espesor}")

    #MODIFICACION DE ESPESORES
   
    if tipo[e] == Placa:
        if -50.0 < sigma[0] < 250.0:
            properties_0["t"] = properties_0["t"] - 0.2
...
pene = 12
write_element_data("sigma_x_OFICIAL_"+str(pene)+".msh",elementos,sigma_xx,"Sigma_x")
